...
import { pluralize, qNameJoin, qNameSplit, recase, singularize } from './types.js';
...
export class AutoRelater {
    ...
    addRelation(table, fkFieldName, spec, fkFields) {
        ...
        const targetModel = recase(this.caseModel, spec.foreignSources.target_table, this.singularize);
        ...
        if (spec.isPrimaryKey) {
            ...
            if (otherKeys.length === 1) {
                ...
                const otherModel = recase(this.caseModel, otherKey.foreignSources.target_table, this.singularize);
