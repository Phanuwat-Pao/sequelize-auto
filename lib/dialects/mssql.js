...
import { addTicks, makeCondition } from './dialect-options.js';
export const mssqlOptions = {
    name: 'mssql',
    hasSchema: true,
    /**
     ...
     */
    isSerialKey: (record) => {
        return (_.isObject(record) && mssqlOptions.isPrimaryKey(record) && _.has(record, 'is_identity') && record.is_identity);
    },
    /**
