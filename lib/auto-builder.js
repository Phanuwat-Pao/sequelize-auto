    ...
    mapForeignKeys(table) {
        ...
        function assignColumnDetails(row, ix, rows) {
            ...
            if (!lodash_1.default.isEmpty(lodash_1.default.trim(ref.source_column)) && !lodash_1.default.isEmpty(lodash_1.default.trim(ref.target_column))) {
                ...
                ref.foreignSources = lodash_1.default.pick(ref, [
                    'source_table',
                    'source_schema',
                    'target_schema',
                    'target_table',
    ...
    mapTable(table) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (this.dialect.showElementTypeQuery &&
                    (lodash_1.default.some(fields, { type: 'ARRAY' }) || lodash_1.default.some(fields, { type: 'USER-DEFINED' }))) {
                ...
                if (this.dialect.showPrecisionQuery &&
                    (lodash_1.default.some(fields, { type: 'DECIMAL' }) || lodash_1.default.some(fields, { type: 'NUMERIC' }))) {
                ...
                this.tableData.indexes[makeTableQName(table)] = (yield this.queryInterface.showIndex({
